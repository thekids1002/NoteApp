...
public class NotesListAdapter extends RecyclerView.Adapter<NoteViewHolder> {
    ...
    public NoteViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new NoteViewHolder(LayoutInflater.from(
                context
    ...
    public void onBindViewHolder(@NonNull NoteViewHolder holder, int position) {
        ...
        holder.notes_container.setCardBackgroundColor(holder.itemView.getResources().getColor(list.get(position).getColor()));
